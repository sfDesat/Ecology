...
**Frozen Ocean** — in progress

- Ice Edge — in progress
- Polynya — in progress
- Sympagic Zone — in progress

**Cold Ocean** — in progress

- Kelp Forest — in progress
- Cold Eelgrass — in progress

**Ocean** (temperate) — in progress

- Seagrass Meadow — in progress
- Temperate Rocky Reef — in progress
- Sand Wave Field — in progress

**Lukewarm Ocean** — in progress

- Subtropical Seagrass — in progress
- Patch Reef — in progress
- Soft Coral Garden — in progress

**Warm Ocean** — in progress

- Coral Reef — in progress
- Lagoon — in progress
- Tropical Seagrass — in progress
...
Animals: Copepods, black guillemots, bowhead whales, narwhals, orcas.
...
Animals: Sand shrimp, sea cucumbers, Atlantic or Pacific cod.
...
Tall giant-kelp canopy over rock and gravel. Deeper bands may thin into urchin barrens within the same biome. Dense vertical kelp trunks, green light filtering down, rocky holdfasts.

Animals: Kelp bass, purple sea urchins, sea otters, leopard sharks.

#### Cold Eelgrass

Habitat pocket inside Cold Ocean. Temperature: cold (~0.2). Depth: about 0–10 below sea level (Y 63–53).

Shallow cold meadow of eelgrass on sand and mud, quieter than the kelp forest. Soft green blades on a sandy-muddy floor, calm nearshore water.

Animals: Pacific herring, moon snails, Dungeness crabs, great blue herons at the surface.
...
Animals: Sand dollars, lugworms, flounder or plaice.

#### Seagrass Meadow

Habitat pocket inside Ocean. Temperature: temperate (0.5). Depth: about 0–15 below sea level (Y 63–48).

Dense temperate seagrass beds — nursery habitat and filter-feeder ground. Thick seagrass carpet, soft sand and clay floor, clearer sheltered feel than the plain shelf.

Animals: Temperate seahorses, pipefish, bay scallops, gray seals.

#### Temperate Rocky Reef

Habitat pocket inside Ocean. Temperature: temperate (0.5). Depth: about 15–30 below sea level (Y 48–33).

Hard-bottom reef of rock piles, cobble, and gravel — structure for fish and crustaceans. Cobble mounds, stone spires, gravel pockets, sparse seagrass between rocks.

Animals: Cunner, moon jellyfish, Atlantic wolffish, lobsters, diving cormorants.

#### Sand Wave Field

Habitat pocket inside Ocean. Temperature: temperate (0.5). Depth: about 30–45 below sea level (Y 33–18).

Deeper mid-shelf sand ripples and wave-sorted beds with little plant cover. Broad sand dunes and ripples, almost barren of seagrass.

Animals: Sand eels (sandlance), thornback rays.
...
Animals: Hermit crabs, sea pens, bonefish.

#### Subtropical Seagrass

Habitat pocket inside Lukewarm Ocean. Temperature: lukewarm. Depth: about 0–10 below sea level (Y 63–53).

Shallow subtropical grass beds — turtle grazing and seahorse shelter. Soft seagrass on pale sand, warm clear shallows.

Animals: Seahorses, pinfish, green sea turtles, dugong.

#### Patch Reef

Habitat pocket inside Lukewarm Ocean. Temperature: lukewarm. Depth: about 10–20 below sea level (Y 53–43).

Scattered hard-coral patches on sand — not a continuous barrier reef. Isolated coral heads and rubble, sandy corridors between them.

Animals: Moray eels in crevices, parrotfish, nurse sharks.

#### Soft Coral Garden

Habitat pocket inside Lukewarm Ocean. Temperature: lukewarm. Depth: about 25–45 below sea level (Y 38–18).

Deeper soft-coral and sea-fan gardens on the outer lukewarm shelf. Soft branching corals and fans over sand and rock, quieter light than the surface.

Animals: Butterflyfish, sea fans, spiny lobsters.
...
Animals: Sea cucumbers, bristle worms, stingrays resting on sand.

#### Coral Reef

Habitat pocket inside Warm Ocean. Temperature: warm. Depth: about 10–20 below sea level (Y 53–43).

Classic hard coral reef — the tropical showpiece pocket. Dense coral structure, bright fish traffic, clear turquoise water.

Animals: Clownfish, angelfish, octopus, blacktip reef sharks.

#### Lagoon

Habitat pocket inside Warm Ocean. Temperature: warm. Depth: about 0–8 below sea level (Y 63–55).

Sheltered very shallow tropical water behind reef or shore — calm, bright, plant-rich. Glass-clear shallows, sand bottom, quiet surface.

Animals: Upside-down jellyfish on the bottom, needlefish at the surface, manatees or dugongs.

#### Tropical Seagrass

Habitat pocket inside Warm Ocean. Temperature: warm. Depth: about 0–12 below sea level (Y 63–51).

Warm seagrass flats distinct from the subtropical meadow — turtles stay on subtropical seagrass to keep the two apart. Seagrass on pale tropical sand, clear water.

Animals: Blue tangs, queen conchs.
