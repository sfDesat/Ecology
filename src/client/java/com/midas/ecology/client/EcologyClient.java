...
public class EcologyClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		DistantWaterShaderSupport.applyConfigQuiet();
		ClientTickEvents.END_CLIENT_TICK.register(client -> DistantWaterShaderSupport.clientTick());
		EcologyMod.LOGGER.info(
			...
			DistantWaterShaderSupport.statusSummary()
		);
	}
}
